...
```powershell
irm https://raw.githubusercontent.com/rt25ai/codex-rtl-rt-ai/v0.1.6/install-online.ps1 | iex
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/rt25ai/codex-rtl-rt-ai/v0.1.6/install-online.sh | bash
```
...
**Windows:**
```powershell
irm https://raw.githubusercontent.com/rt25ai/codex-rtl-rt-ai/v0.1.6/uninstall-online.ps1 | iex
```

**macOS:**
```bash
curl -fsSL https://raw.githubusercontent.com/rt25ai/codex-rtl-rt-ai/v0.1.6/uninstall-online.sh | bash
```
...
- **Trust model:** the one-line installer is pinned to a signed release
  tag (currently `v0.1.6`), not the `main` branch. A compromised `main`
